...
public class add_student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSIT", "BSCS", "BSBA", "BSED", "BEED", "BSN", "BSHM", "BSTM", "BSAT", "BSA" }));
    ...
    try {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(file, true))) {
            bw.write(studentId + "|" + name + "|" + course + "|" + year);
            bw.newLine();
...
private boolean studentExists(String studentId) {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
        ...
        JOptionPane.showMessageDialog(null, "Error checking student existence");
    }
    return false;
